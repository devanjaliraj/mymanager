        ...
        <Row>
          ...
          <Col lg="3" sm="6">
            <StatsHorizontal
              ...
              renderStats={<h3 className="fw-bolder mb-75"> {data?.data?.filter(x=>x.status==="PARTIAL PAYMENT").length}</h3>}
            />
          </Col>
          <Col lg="3" sm="6">
            <StatsHorizontal
              ...
              renderStats={<h3 className="fw-bolder mb-75"> {data?.data?.filter(x=>x.status==="PAID").length}</h3>}
            />
          </Col>
          <Col lg="3" sm="6">
            <StatsHorizontal
              ...
              statTitle="Past Due"
              icon={<UserX size={20} />}
              renderStats={<h3 className="fw-bolder mb-75"> {data?.data?.filter(x=>x.status==="DUE").length}</h3>}
            />
          </Col>
        </Row>
      </div>
