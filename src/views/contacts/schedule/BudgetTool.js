      ...
      <table className="w-100 bordered-table">
        ...
        <tbody>
          <td className="border">
            <div className="d-flex justify-content-between p-50 align-items-center">
              ...
              <div className="d-flex ">
                <span className="labour-header-badge d-flex h-100 align-items-center px-50 font-medium-1 px-1">
                  {totalPercentage}%
                </span>
                <span
          ...
          <td className="border" colSpan={2}>
            <div className="d-flex justify-content-around">
              <span className="labour-header-badge d-flex h-100 align-items-center ms-50 font-medium-1 px-1">
                ...
                <tbody>
                  <td className="border">
                    <div className="d-flex justify-content-between p-50 align-items-center">
                      ...
                      <div className="d-flex ">
                        <span className="labour-header-badge d-flex h-100 align-items-center px-50">
                          0%
                        </span>
                        <span
