...
const EditContactSideBar = ({ open, toggleSidebar }) => {
  ...
  const [criteriaType, setCriteriaType] = useState({ value: 'Date of Birth', label: 'Date of Birth' });
          ...
          <Row>
            ...
            {activationUpon != null && activationUpon.value == "Criteria Met" &&
              <Col>
                ...
                />
                {activationUpon != null && activationUpon.value == "Criteria Met" && criteriaType.value == "Retention Rating" &&
                  <div className='mt-1'>
            ...
            {activationUpon != null && activationUpon.value == "Upon Entry" && activateTime == 'Custom Time Delay' && (
              <div style={{ zIndex: '0' }}>
                <Col
            ...
            {activationUpon != null && activationUpon.value == "Criteria Met" && activateTime == 'Custom Time Delay' && (
              <div style={{ zIndex: '0' }}>
                <Col
                  className="compose-mail-form-field d-flex mt-1 justify-content-between center"
                  style={{ zIndex: '0' }}
