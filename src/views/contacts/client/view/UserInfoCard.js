...
const UserInfoCard = ({ selectedUser, store,notes }) => {
  ...
  return (
    <Fragment>
                ...
                <div className="user-info">
                  ...
                  {selectedUser !== null ? (
                    <>
                      ...
                      <Badge className="text-capitalize" color={selectedUser.isFormer=== true ? statusColors.former : statusColors.active}>
                        {selectedUser.isFormer===true ? 'Former' : 'Active'}
                      </Badge>
                      <Badge className="text-capitalize ms-50" color={store?.leadSources?.find(x=>x.title === selectedUser.leadSource)?.color}>
            ...
            <Row className="gy-1">
              ...
              <Col md={6} xs={12}>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  />
                  <Button color='outline-primary' onClick={toggleNewTag} className="ms-50">Add</Button>
                </div>
              </Col>
              <Col md={6} xs={12}>
                <Label className="form-label" >
                ...
                <div className="d-flex justify-content-between">
                  ...
                  />
                  <Button color='outline-primary' onClick={toggleNewLeadSource} className="ms-50">Add</Button>
                </div>
              </Col>
              <Col md={12} xs={12}>
                <Label className="form-label" for="billing-email">
      ...
      {store && store.leadSources && (<AddNewLeadSourceModal
        open={openLeadSource}
        store={store}
        dispatch={dispatch}
