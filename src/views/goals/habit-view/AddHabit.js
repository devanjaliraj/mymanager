    ...
    <Fragment>
      ...
      <ModalBody>
        <Form onSubmit={onHabitSubmit}>
          ...
          <Input type='text' value={habitPayload?.repetition || 21} required />
          <Input name="repetition" type="range" defaultValue={21} max={100} color="primary" step="1" value={habitPayload?.repetition} onChange={handleInput} required />
