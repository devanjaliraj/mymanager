...
const UserInfoCard = ({ selectedUser, notes, store }) => {
  // ** State
                    ...
                    {selectedUser !== null ? (
                      <>
                        <Badge
                          ...
                          className="text-capitalize me-50"
                        >
                          {selectedUser?.role?.roleName ? selectedUser?.role?.roleName : 'other'}
                        </Badge>
                        <Badge
            ...
            <Row className="gy-1">
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  theme={selectThemeColors}
                  name="isFormer"
                  onChange={(e) => onchangeHandler('isFormer', e.value)}
                  defaultValue={{
                    value: selectedUser?.isFormer,
                    label: selectedUser?.isFormer === true ? 'Former' : 'Active'
                  }}
                />
              </Col>
              ...
              <Col md={6} xs={12}>
                ...
                <div className="d-flex justify-content-between">
                  <Select
                    ...
                    classNamePrefix="select"
                    defaultValue={{
                      value: selectedUser?.leadSource,
                      label: selectedUser?.leadSource
                    }}
