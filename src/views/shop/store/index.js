...
export const getUsers = createAsyncThunk('appEcommerce/getUsers', async () => {
  let url = `/user/get_users`;
  const response = await API.get(url);
  return response.data;
});

export const getMemberships = createAsyncThunk('appEcommerce/getMemberships', async (params) => {
...
export const getMembership = createAsyncThunk('appEcommerce/getMembership', async (slug) => {
...
export const checkoutProduct = createAsyncThunk('appEcommerce/checkoutProducts', async (params) => {
...
export const getPublicProducts = createAsyncThunk('appEcommerce/getPublicProducts', async (params) => {
  let url = `/product/public_products`;
  const response = await PUBLIC_API.get(url, { params });
  const { data, total } = response.data;
  return { params, data, total };
});
export const getPublicProduct = createAsyncThunk('appEcommerce/getPublicProduct', async (slug) => {
...
export const addToCart = createAsyncThunk('appEcommerce/addToCart', async (id, { dispatch }) => {
