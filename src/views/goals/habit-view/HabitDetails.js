...
export default function HabitDetails({ toggle, open, closeMain, task, dispatch, store, workspaceId }) {
          ...
          <OffcanvasBody className="p-0">
            <>
              ...
              <TabContent activeTab={tab} >
                <TabPane tabId="1">
                  {task.type === 'target' && (
                    <>
                      ...
                      <GoalRecord task={task} store={store} dispatch={dispatch} row={selectedTask} />
                ...
                <TabPane tabId="3">
                  {task && task?.type === 'target' ? (<ActionPlanTab task={task} />) : (<HabitActionPlanTab task={task} />)}
                </TabPane>
                <TabPane tabId="4">
